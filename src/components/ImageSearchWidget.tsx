...
export default function ImageSearchWidget() {
    ...
    const handleImageSearch = async () => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(errorData.error || `Image search failed with status ${response.status}`);
            }
            ...
            setSearchError(err instanceof Error ? err.message : "An unknown image search error occurred.");
        } finally {
    ...
    console.log(`ImageSearchWidget render: isSearching=${isSearching}, previewUrl=${previewUrl}, selectedFile=${selectedFile?.name}`);
