...
const TabsComponent: React.FC<TabsComponentProps> = ({ speciesData, speciesSlug }) => {
  ...
  return (
    <div className="flex flex-col items-center w-full">
      <div className="w-full overflow-x-auto mt-2 flex justify-center scrollbar-hide">
        <div
          className="inline-flex rounded-full border border-gray-300 dark:border-gray-600 bg-white/70 dark:bg-gray-800/70 backdrop-blur-lg whitespace-nowrap"
          role="tablist"
        >
          {tabsData.map((tab) => (
            <button
